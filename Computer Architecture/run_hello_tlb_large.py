...
# TLBs - Virtual Memory (entry_type required in some gem5 versions)
system.cpu.itb = X86TLB(size=256, entry_type="instruction")
system.cpu.dtb = X86TLB(size=256, entry_type="data")
